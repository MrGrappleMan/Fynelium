...
| network.http.pipelining | B   | 1   |
| network.http.proxy.pipelining | B   | 1   |
| network.http.pipelining.maxrequests | I   | 256 |
| network.http.max-connections | I   | 256 |
| network.http.max-connections-per-server | I   | 256 |
| network.http.max-persistent-connections-per-proxy | I   | 256 |
| network.http.max-persistent-connections-per-server | I   | 256 |
| network.dns.disableIPv6 | B   | 0   |
| network.dns.disablePrefetch | B   | 0   |
| toolkit.cosmeticAnimations.enabled | B   | 0   |
| browser.sessionstore.interval | I   | 600000 |
